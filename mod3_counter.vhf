...
ENTITY FJKP_MXILINX_mod3_counter IS
   PORT ( C	:	IN	STD_LOGIC; 
          J	:	IN	STD_LOGIC; 
          K	:	IN	STD_LOGIC; 
          PRE	:	IN	STD_LOGIC; 
...
end FJKP_MXILINX_mod3_counter;

ARCHITECTURE SCHEMATIC OF FJKP_MXILINX_mod3_counter IS
   SIGNAL A0	:	STD_LOGIC;
   SIGNAL A1	:	STD_LOGIC;
   SIGNAL A2	:	STD_LOGIC;
   SIGNAL AD	:	STD_LOGIC;
...
-- Vhdl model created from schematic mod3_counter.sch - Mon Sep 27 22:57:48 2004
...
ARCHITECTURE SCHEMATIC OF mod3_counter IS
   ...
   COMPONENT FJKP_MXILINX_mod3_counter
      PORT ( C	:	IN	STD_LOGIC; 
             J	:	IN	STD_LOGIC; 
             K	:	IN	STD_LOGIC; 
             PRE	:	IN	STD_LOGIC; 
...
BEGIN
   ...
   XLXI_26 : AND2
      PORT MAP (I0=>XLXN_43, I1=>XLXN_42, O=>XLXN_45);

   XLXI_31 : FJKP_MXILINX_mod3_counter
      PORT MAP (C=>XLXN_33, J=>XLXN_2, K=>XLXN_2, PRE=>XLXN_45, Q=>Q0_DUMMY);

   XLXI_32 : FJKP_MXILINX_mod3_counter
